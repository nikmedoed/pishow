...
def _update_device_info_from_form(
        request: Request,
        device_id: str,
        photo_time: int,
        only_photo: bool,
    ...
    device_queue_manager.update_device_info(
        ...
        force_reset_queue=force_reset_queue,
    )
